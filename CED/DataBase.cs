...
namespace MicrosoftAccessAPI
{
    ...
    {
        public static bool database_delete(string Address, string Table,string header, object target)
        {
            try
            {
        ...
        public static DataTable database_read(string Address, string Table)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static DataTable database_read(string Address, string Table,string Condition,string Content)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static DataTable database_read(string Address, string Table, string Condition, int Content)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static bool database_update(string Address, string Table,DataTable dt)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static bool database_update(string Address, string Table, DataRow[] dra)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static void database_update(string Address, string Table, DataTable dt,string Condition, string Content)
        {
            try
            {
                string strconn = @"Provider=Microsoft.Ace.OLEDB.12.0; Data Source='" + Address + "';";
        ...
        public static bool database_update(string Address, string Table,string SearchCondition1,string username,string SearchTarget,string TargetContent)
        {
            try
            {
        ...
        public static bool database_check(string Address, string Table, string username, string pw, string SearchCondition1, string SearchCondition2)
        {
            //database_sea()
            try
            {
        ...
        public static int database_search(string Address, string Table, string username, string pw, string SearchCondition1, string SearchCondition2, string SearchTraget)
        {
            try
            {
                //string s2 = "SELECT * FROM " + Table + " WHERE ((" + c1 + " = '" + username.Trim() + "') AND (" + c2 + " = '" + pw.Trim() + "'))";
        ...
        public static bool database_check2(string Address, string Table, string username, string pw, string SearchCondition1, string SearchCondition2)
        {
            try
            {
                //string s2 = "SELECT * FROM " + Table + " WHERE ((" + c1 + " = '" + username.Trim() + "') AND (" + c2 + " = '" + pw.Trim() + "'))";
        ...
        public static bool database_add_newUser(string Address, string Table, DataRow dr)
        {
            try
            {
                string temp = "'" + dr[0] + "'";
